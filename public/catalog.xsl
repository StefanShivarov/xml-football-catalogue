...
<xsl:stylesheet
	...
	xmlns:fb="http://www.example.com/football" version="2.0">
			...
			<body class="font-sans text-gray-300 bg-gradient-to-b from-black to-gray-900">
				<div class="container mx-auto p-6">
					...
					<div class="text-center mb-8">
                     ...
                     class="px-8 py-4 rounded-full bg-gradient-to-br from-gray-900 via-gray-800 to-black mr-3
                     text-white font-semibold tracking-wider uppercase border border-gray-700 
                     shadow-[inset_0_-2px_6px_rgba(0,0,0,0.7),_0_2px_8px_rgba(255,255,255,0.1)] 
                     hover:shadow-[0_0_15px_2px_rgba(0,100,200,0.5)] hover:border-blue-500 
                     ...
                     class="px-8 py-4 rounded-full bg-gradient-to-br from-gray-900 via-gray-800 to-black 
                     text-white font-semibold tracking-wider uppercase border border-gray-700 
                     shadow-[inset_0_-2px_6px_rgba(0,0,0,0.7),_0_2px_8px_rgba(255,255,255,0.1)] 
                     hover:shadow-[0_0_15px_2px_rgba(0,100,200,0.5)] hover:border-blue-500 
                     transition-all duration-300 ease-in-out">
			...
			<div class="flex items-start gap-6 mb-4">
				...
				<div>
					...
					<p class="text-sm text-gray-400">
						...
						<xsl:value-of select="fb:city" /> | Founded: 
	...
	<xsl:template match="fb:coach">
		<div class="flex items-center gap-3">
			...
			<div>
				...
				<p class="text-xs text-gray-400">Nationality: 
